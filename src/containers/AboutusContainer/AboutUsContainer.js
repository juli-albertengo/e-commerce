        ...
        <div className='container-lg'>
            ...
            <div className='row justify-content-center align-items-center'>
                <div className='col-lg-4 col-sm-12'>
                    ...
                    <p className='fuente'>In our Bookstore we want to sell books, so we encourage you to read more. Plus inspirational things here..</p>
            ...
            <div>
                ...
                <div className='row my-3'>
                    ...
                    <div className='col-md-6 col-sm-12'>
                        <h3 className='my-1 fuente'>Contact Details</h3>
                        <p className='my-2 contact__p'>bookstore@gmail.com</p>
                        <p className='my-2 contact__p'>instagram/bookstore</p>
                        <p className='my-2 contact__p'>facebook/bookstore</p>
                    </div>
                </div>
            </div>
        </div>
